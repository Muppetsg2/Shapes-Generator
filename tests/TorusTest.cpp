...
TEST_CASE("ShapesGenerator.Torus.Generation(MS[3]IS[3]MR[1.0]IR[0.2].FLAT.TBP)") {
	static const std::vector<Vertex> expectedVertices = {
		...
		{ {   0.75f, -0.144338f,        0.f }, {       1.f, 0.333333f }, { -0.612372f, -0.707107f,  0.353553f }, {       -0.f,        0.f,       -0.f }, {  0.377965f, -0.654653f, -0.654654f } },
		{ {     1.f,        0.f,        0.f }, {       0.f,       1.f }, {  0.387298f, -0.894427f, -0.223607f }, { -0.774597f, -0.447214f,  0.447214f }, {      -0.5f,       -0.f, -0.866025f } },
		{ { -0.375f, -0.144338f,  0.649519f }, { 0.333333f, 0.333333f }, {  0.387298f, -0.894427f, -0.223607f }, { -0.774597f, -0.447214f,  0.447214f }, {      -0.5f,       -0.f, -0.866025f } },
		{ {   0.75f, -0.144338f,        0.f }, {       0.f, 0.333333f }, {  0.387298f, -0.894427f, -0.223607f }, { -0.774597f, -0.447214f,  0.447214f }, {      -0.5f,       -0.f, -0.866025f } },
		...
		{ {   0.75f, -0.144338f,        0.f }, {       1.f, 0.333333f }, { -0.387298f, -0.894427f, -0.223607f }, {  0.774597f, -0.447214f,  0.447214f }, {      -0.5f,       -0.f,  0.866025f } },
		{ { -0.375f, -0.144338f, -0.649519f }, { 0.666667f, 0.333333f }, { -0.387298f, -0.894427f, -0.223607f }, {  0.774597f, -0.447214f,  0.447214f }, {      -0.5f,       -0.f,  0.866025f } },
		{ {   0.75f, -0.144338f,        0.f }, {       1.f, 0.333333f }, {        0.f, -0.707107f, -0.707107f }, {   0.92582f, -0.267261f,  0.267261f }, { -0.377964f, -0.654654f,  0.654653f } },
		{ {   -0.5f,        0.f, -0.866025f }, { 0.666667f,       1.f }, {        0.f, -0.707107f, -0.707107f }, {   0.92582f, -0.267261f,  0.267261f }, { -0.377964f, -0.654654f,  0.654653f } },
		{ {     1.f,        0.f,        0.f }, {       1.f,       1.f }, {        0.f, -0.707107f, -0.707107f }, {   0.92582f, -0.267261f,  0.267261f }, { -0.377964f, -0.654654f,  0.654653f } }
	};
...
TEST_CASE("ShapesGenerator.Torus.Generation(MS[5]IS[5]MR[1.2]IR[1.0].SMOOTH.TBP)") {
	static const std::vector<Vertex> expectedVertices = {
		...
		{ {  0.177719f,  0.267175f,        0.f }, {  0.f, 0.2f }, { -0.809017f,  0.587785f,        0.f }, { -0.230845f, -0.317732f,  0.919651f }, {  0.540557f,  0.744013f,  0.392738f } },
		{ {  0.054918f,  0.267175f,  0.169021f }, { 0.2f, 0.2f }, {     -0.25f,  0.587785f, -0.769421f }, { -0.967162f, -0.114014f,  0.227151f }, {  0.045791f,  0.800943f,  0.596987f } },
		{ { -0.143778f,  0.267175f,  0.104461f }, { 0.4f, 0.2f }, {  0.654509f,  0.587785f, -0.475528f }, { -0.514903f, -0.114014f, -0.849633f }, { -0.553619f,  0.800943f,  0.228029f } },
		{ { -0.143778f,  0.267175f, -0.104461f }, { 0.6f, 0.2f }, {  0.654508f,  0.587785f,  0.475528f }, {  0.648935f, -0.114014f, -0.752253f }, { -0.387946f,  0.800943f, -0.456058f } },
		{ {  0.054918f,  0.267175f, -0.169021f }, { 0.8f, 0.2f }, {     -0.25f,  0.587785f,  0.769421f }, {  0.915967f, -0.114014f,  0.384715f }, {  0.313855f,  0.800943f, -0.509888f } },
		...
		{ {  0.054918f, -0.267175f,  0.169021f }, { 0.2f, 0.2f }, {     -0.25f, -0.587785f, -0.769421f }, { -0.915967f, -0.114014f,  0.384715f }, { -0.313855f,  0.800943f, -0.509888f } },
		{ { -0.143778f, -0.267175f,  0.104461f }, { 0.4f, 0.2f }, {  0.654509f, -0.587785f, -0.475528f }, { -0.648935f, -0.114015f, -0.752253f }, {  0.387946f,  0.800943f, -0.456058f } },
		{ { -0.143778f, -0.267175f, -0.104461f }, { 0.6f, 0.2f }, {  0.654508f, -0.587785f,  0.475528f }, {  0.514903f, -0.114014f, -0.849633f }, {  0.553619f,  0.800943f,  0.228029f } },
		{ {  0.054918f, -0.267175f, -0.169021f }, { 0.8f, 0.2f }, {     -0.25f, -0.587785f,  0.769421f }, {  0.967162f, -0.114015f,  0.227151f }, { -0.045791f,  0.800943f,  0.596988f } },
		{ {   0.17772f, -0.267175f,        0.f }, {  1.f, 0.2f }, { -0.809017f, -0.587785f,       -0.f }, {  0.230845f, -0.317731f,  0.919651f }, { -0.540557f,  0.744013f,  0.392738f } },
		...
		{ {   0.21196f, -0.432298f, -0.652346f }, { 0.8f, 0.6f }, {  0.095492f, -0.951056f, -0.293893f }, {  0.951056f,        0.f,  0.309017f }, { -0.293893f, -0.309017f,  0.904508f } },
